    ...
    <el-card class="box-card profile-card" v-if="userId.user">
      <div class="profile-info">
        <div class="info-item">
          ...
          <span class="info-value">{{ userId.username }}</span>
        </div>
        <div class="info-item">
          <span class="info-label">Họ và tên:</span>
          <span class="info-value">{{ userId.fullName }}</span>
        </div>
        <div class="info-item">
          <span class="info-label">Email:</span>
          <span class="info-value">{{ userId.email }}</span>
        </div>
        <div class="info-item">
          <span class="info-label">Số điện thoại:</span>
          <span class="info-value">{{ userId.phone }}</span>
        </div>

        <div class="info-item">
          <span class="info-label">Trạng thái:</span>
          <span class="info-value">
            <el-tag :type="userId.status === 'ACTIVE' ? 'success' : 'danger'">
              {{ userId.status }}
            </el-tag>
          </span>
        </div>
