      ...
      <div class="profile-info">
        ...
        <div class="info-item">
          ...
          <span class="info-value">
            <e lag :type="authStore.user.status === 'ACTIVE' ? 'success' : 'danger'">
...
<script setup>
// (script setup giữ nguyên như cũ)
import { ref } from 'vue'
...
.profile-card { max-width: 600px; margin: 20px auto; padding: 20px; }
.profile-info .info-item { display: flex; margin-bottom: 15px; font-size: 1rem; }
.profile-info .info-label { font-weight: 600; width: 150px; color: #606266; }
.profile-info .info-value { flex: 1; color: #303133; }
