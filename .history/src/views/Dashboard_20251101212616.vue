<template>
  ...
  // import PieChart from '@/components/charts/PieChart.vue' // (Nếu dùng)
  ...
  const fetchDashboardData = async () => {
    ...
    // (Bạn có thể gọi API Chi phí tại đây nếu muốn dùng Pie chart)
  }
  ...
  .kpi-value.revenue { color: #409EFF; }
  .kpi-value.cost { color: #F56C6C; }
  .kpi-value.profit { color: #67C23A; }
  
  .chart-card {
    height: 450px; /* Đảm bảo các card biểu đồ cao bằng nhau */
  }
