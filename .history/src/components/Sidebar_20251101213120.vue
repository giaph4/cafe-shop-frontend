<template>
    <el-aside class="sidebar" width="250px">
        ...
        <el_menu :default-active="activeMenu" class="sidebar-menu" background-color="var(--sidebar-bg)"
...
// Lấy danh sách routes từ router/index.js (chỉ lấy các route con của DefaultLayout)
...
const hasPermission = (route) => {
    ...
    return false // Ẩn nếu không được định nghĩa roles
}

// Tự động highlight menu item đang active
const activeMenu = computed(() => {
    // route.path có thể là /products/1, nhưng chúng ta muốn highlight /products
