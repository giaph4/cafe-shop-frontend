...
const fetchOrders = async () => {
    ...
    try {
        ...
        allOrders.value = response.data.sort((a, b) => new Date(b.createdAt) - new Date(a.createdAt));
    } catch (error) {
...
const handleOrderClick = (order) => {
    // Dispatch với namespace 'pos/selectOrder'
    store.dispatch('pos/selectOrder', order.id);
};
