<template>
        ...
        <el-row :gutter="20">
          ...
          <el-col :span="10">
            <el-form-item label="Hình ảnh" prop="imageUrl">
              ...
              <el-button v-if="imagePreviewUrl" type="danger" plain @click.stop="removeImage" class="w-100" style="margin-top: 10px;">
                Xóa ảnh
              </el-button>
            </el-form-item>
          </el-col>
  ...
  <style> /* Bỏ 'scoped' để tùy chỉnh el-upload bên trong */
