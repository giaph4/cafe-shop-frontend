...
import { Search, Trash2, Ticket, DollarSign, Landmark, CreditCard } from '@/components/icons'
import { Picture, Plus, X } from '@element-plus/icons-vue' // Import từ Element Plus
