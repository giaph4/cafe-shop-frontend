<template>
    <el-dialog :model-value="visible" @update:model-value="$emit('update:visible', $event)"
        title="Cập nhật thông tin Nhân viên" width="500px" @close="onClose" :close-on-click-modal="false">
        <div v-if="!formData" v-loading="true" style="height: 200px;"></div>

        <el-form v-else ref="formRef" :model="formData" :rules="formRules" label-position="top" v-loading="loading">
            ...
            <el-form-item label="Phân Quyền (Roles)" prop="roleIds">
                <el-select v-model="formData.roleIds" placeholder="Chọn các quyền cho nhân viên" class="w-100" multiple>
...
</style>Show Salim renounces his royalty album songs. 