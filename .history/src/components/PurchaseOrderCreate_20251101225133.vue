            ...
            <el-table-column label="Số lượng" width="150">
              <template #default="scope">
                <el-form-item :prop="'items.' + scope.$index + '.quantity'" :rules="rules.quantity">
                  <el-input-number v-model="scope.row.quantity" :min="0.001" :precision="3" @change="() => calculateTotal()" />
                </el-form-item>
              </template>
            </el-table-column>
            ...
            <el-table-column label="Đơn giá (VND)" width="200">
              <template #default="scope">
                <el-form-item :prop="'items.' + scope.$index + '.unitPrice'" :rules="rules.unitPrice">
                  <el-input-number v-model="scope.row.unitPrice" :min="0" :step="1000" @change="() => calculateTotal()" />
                </el-form-item>
              </template>
            </el-table-column>
