<template>
              ...
              <div class="product-list">
                ...
                >
                  <el-image :src="product.imageUrl" fit="cover" class="product-item-img">
                    <template #error>
                      <div class="image-slot-small"><Picture /></div>
                    </template>
                  </el-image>
                    ...
                    <div v-else class="cart-item" v-for="item in posStore.orderItems" :key="item.id">
                      <div class="cart-item-info">
                        ...
                        <el-input
                          ...
                          size="small"
                          @change="(newNote) => onNoteChange(item.id, newNote)"
                  ...
                  <div class="payment-tab">
                    ...
                    <el-form-item label="Chọn phương thức thanh toán">
                      <div class="payment-methods">
                        ...
                        <el-button size="large" @click="onPay('TRANSFER')" :icon="Landmark">Chuyển khoản (TRANSFER)</el-button>
  ...
  .product-list {
    height: calc(80vh - 60px); /* 60px là header card */
    overflow-y: auto;
    padding: 15px;
    display: grid;
