...
const routes = [
    {
        ...
        children: [
            ...
            {
                path: 'purchase-orders/create', // Trang Tạo mới
                name: 'PurchaseOrderCreate',
                component: PurchaseOrderCreate,
                meta: { title: 'Tạo Phiếu nhập', icon: 'Truck', roles: [ROLES.MANAGER, ROLES.ADMIN] }
                // (Không hiển thị trên sidebar, nhưng vẫn cần để điều hướng)
            },
            {
                path: 'suppliers',
                name: 'Suppliers',
