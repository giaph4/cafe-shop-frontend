...
/* Order statuses */
.dot-pending { background: var(--warning-500); }
.dot-paid { background: var(--success-500); }
.dot-cancelled { background: var(--danger-500); }
.dot-completed { background: var(--success-500); }

/* Table statuses */
.dot-empty { background: var(--success-500); }
.dot-serving { background: var(--danger-500); }
.dot-reserved { background: var(--warning-500); }

/* Purchase Order statuses */
.dot-draft { background: var(--info-500); }
.dot-ordered { background: var(--warning-500); }
.dot-received { background: var(--success-500); }

/* User statuses */
.dot-active { background: var(--success-500); }
.dot-inactive { background: var(--danger-500); }

/* Payment statuses */
.dot-cash { background: var(--success-500); }
.dot-transfer { background: var(--primary-500); }
.dot-card { background: var(--warning-500); }
